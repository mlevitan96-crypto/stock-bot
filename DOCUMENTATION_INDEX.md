...
- **[EXECUTIVE_SUMMARY_README.md](EXECUTIVE_SUMMARY_README.md)** - Executive summary of bot capabilities
- **[CONTEXT.md](CONTEXT.md)** - Project context and key files reference

### **Architecture & Workflow**
- **[TRADING_BOT_WORKFLOW.md](TRADING_BOT_WORKFLOW.md)** - Complete trading workflow documentation
- **[ALPACA_TRADING_BOT_WORKFLOW.md](ALPACA_TRADING_BOT_WORKFLOW.md)** - Detailed Alpaca integration workflow
- **[ARCHITECTURE_MAPPING_REVIEW.md](ARCHITECTURE_MAPPING_REVIEW.md)** - Architecture mapping and review

### **Learning System**
- **[LEARNING_SCHEDULE_AND_PROFITABILITY.md](LEARNING_SCHEDULE_AND_PROFITABILITY.md)** - Learning schedule and profitability tracking
- **[COMPREHENSIVE_LEARNING_SYSTEM.md](COMPREHENSIVE_LEARNING_SYSTEM.md)** - Comprehensive learning system overview
- **[LEARNING_SYSTEM_FIXES.md](LEARNING_SYSTEM_FIXES.md)** - Learning system fixes and improvements
- **[LEARNING_BEST_PRACTICES.md](LEARNING_BEST_PRACTICES.md)** - Best practices for learning system

### **Deployment & Operations**
- **[ZERO_DOWNTIME_DEPLOY.md](ZERO_DOWNTIME_DEPLOY.md)** - Zero downtime deployment guide
- **[COMPLETE_DEPLOYMENT_PHASE3.md](COMPLETE_DEPLOYMENT_PHASE3.md)** - Phase 3 deployment guide
- **[DROPLET_DEPLOYMENT_GUIDE.md](DROPLET_DEPLOYMENT_GUIDE.md)** - Droplet deployment procedures

### **Testing & Verification**
- **[backtest_30_day.py](backtest_30_day.py)** - 30-day historical backtest script
- **[backtest_all_implementations.py](backtest_all_implementations.py)** - Comprehensive implementation backtest
- **[FULL_AUDIT_AND_VERIFICATION.py](FULL_AUDIT_AND_VERIFICATION.py)** - Full system audit script

### **Analysis & Optimization**
- **[OVERFITTING_ANALYSIS_AND_RECOMMENDATIONS.md](OVERFITTING_ANALYSIS_AND_RECOMMENDATIONS.md)** - Overfitting analysis and recommendations
