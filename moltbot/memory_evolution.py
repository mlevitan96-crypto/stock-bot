...
def run_memory_evolution_proposal(
    ...
    """
    Generate Memory Bank change proposal. Never writes MEMORY_BANK_ALPACA.md.
    """
    ...
    lines.extend([
        ...
        "## Approval Required",
        "",
        "Molt does NOT modify MEMORY_BANK_ALPACA.md. Cursor/human must apply approved changes.",
        "",
        "---",
