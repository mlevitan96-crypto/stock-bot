...
# Version: 2026-04-23 (Vanguard double-barrel + continuous PnL ledger + Command Center observability)
# Last Updated: 2026-04-23 (Maintenance Log: epoch decoupled from cumulative PnL chart; persistent ledgers under `state/`)
