...
- **Definitive outcome:** Run on droplet to get a single A/B/C/D: `python3 scripts/wheel_root_cause_report.py --days 5`. Report written to `reports/WHEEL_ROOT_CAUSE_REPORT_YYYY-MM-DD.md` with evidence (log counts, samples, code paths) and fix hints.
