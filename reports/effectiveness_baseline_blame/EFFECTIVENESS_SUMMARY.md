...
Generated: 2026-02-18T16:44:30.162731+00:00
Closed trades (joined): 1
...
|------------------|-----------|------------------|--------------|--------------|---------------|
| profit | 1 | 0.0 | None | 0.0 | 0.0 |

## 3. Entry vs exit blame (losing trades)

- Total losing trades: 0
- % weak entry (entry_score < 3): 0
- % exit timing (high giveback / had MFE): 0

## 4. Counterfactual exit

- Hold longer would have helped: 0 trades
- Exit earlier would have saved loss: 0 trades
