...
Generated: 2026-02-23 16:04 UTC

Evidence: reports/signal_review/signal_funnel.json, signal_funnel.md, top_50_end_to_end_traces.md.
Gate truth report: reports/signal_review/expectancy_gate_truth_200.md. Signal breakdown: reports/signal_review/signal_score_breakdown_summary.md (missing/zero rates per signal).
...
- Gate truth report: reports/signal_review/expectancy_gate_truth_200.md.
- Signal breakdown: reports/signal_review/signal_score_breakdown_summary.md (missing/zero rates per signal).
...
- **Join coverage:** ledger 0.0%, snapshots 43.2%, UW 100.0%, adjustments (pre_norm) 0.0%, **gate truth** 0.0%.
