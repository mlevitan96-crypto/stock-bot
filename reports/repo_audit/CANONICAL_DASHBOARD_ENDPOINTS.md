...
| `/api/stockbot/closed_trades` | logs/attribution.jsonl, logs/exit_attribution.jsonl, logs/telemetry.jsonl |
| `/api/stockbot/wheel_analytics` | Same + reports/*_stock-bot_wheel.json, state/wheel_state.json |
...
| `/api/wheel/universe_health` | state/wheel_universe_health.json; fallback config/universe_wheel.yaml, state/daily_universe_v2.json |
