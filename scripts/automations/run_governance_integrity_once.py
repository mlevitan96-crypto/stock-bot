...
# memory_bank/ was consolidated to MEMORY_BANK.md per MEMORYBANK_CLEANUP_CHANGELOG.md (2026-03-05)
...
def check_repo_structure() -> tuple[str, list[str]]:
    ...
    # memory_bank/ or MEMORY_BANK.md must exist (consolidated per cleanup)
    has_mb = any((REPO_ROOT / alt).exists() for alt in MEMORY_BANK_ALTERNATIVES)
    if not has_mb:
