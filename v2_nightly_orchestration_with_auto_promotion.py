...
# -------------------- Paths (canonical) --------------------
PATHS = {
    "alpha_attribution_v2": CacheFiles.ALPHA_ATTRIBUTION_V2,  # per-fill attribution events
    "orders_log": CacheFiles.V2_ORDERS_LOG,                   # routed orders log
    "sector_profiles": StateFiles.SECTOR_PROFILES,            # produced by sector_rotation_v2
    "canary_registry": StateFiles.CANARY_REGISTRY,            # produced by canary_router_v2
    "metrics_rollup": StateFiles.V2_METRICS,                  # rolling metrics
    "promotion_flag": StateFiles.V2_PROMOTED,                 # promotion gate state
    "audit": CacheFiles.AUDIT_V2_PROMOTION,                   # audit trail for promotion/demotion
}
